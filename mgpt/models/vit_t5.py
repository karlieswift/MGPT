...
from mgpt.models.modeling_t5 import T5Config, T5ForConditionalGeneration


@registry.register_model("vit_t5")
class VITT5(Blip2Base):
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_t5": "configs/models/vitt5.yaml",
    }
    def __init__(
        self,
    ...
    def forward(self, samples):
       ...
       # print(samples["text_input"])
        ...
        # print('-----------------')
        samples["text_output"]=["please describe this picture."]*len(samples["text_input"])
        image = samples["image"]
